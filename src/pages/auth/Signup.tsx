    ...
    <section className='bg-primary-blue min-h-screen bg-no-repeat w-full bg-center bg-contain flex items-center justify-center' style={{'backgroundImage':`url(${background})`}}>
        <aside className='w-[599px] '>
            ...
            <div className='py-10 px-14 bg-white flex flex-col gap-5 rounded-b-lg'>
                ...
                <Link to='/signup/step-two' className='rounded-md bg-[#3058A6] py-3 px-6 text-white text-sm font-medium leading-5 border-[1px] hover:bg-white hover:border-[#3058A6] hover:text-[#3058A6] transition linear text-center'>Sign up with email</Link>
                <p className='text-center'>- or continue with -</p>
                <button className='rounded-md py-3 px-6 text-black text-sm font-medium leading-5 border-[1px] hover:bg-white hover:border-[#3058A6] hover:text-[#3058A6] transition linear flex items-center gap-2 justify-center'><img src={googleG} alt="googleG" /> Google</button>
